...
public class ModRecipes {
    ...
    public static final DeferredRegister<RecipeSerializer<?>> SERIALIZERS =
            DeferredRegister.create(ForgeRegistries.RECIPE_SERIALIZERS, SamMod.MOD_ID);

    //Recipe Types
    public static final DeferredRegister<RecipeType<?>> TYPES =
            DeferredRegister.create(ForgeRegistries.RECIPE_TYPES, SamMod.MOD_ID);

    //These are what are returned in GrowthChamberRecipe.getSerializer()
    //and GrowthChamberRecipe.getType()
