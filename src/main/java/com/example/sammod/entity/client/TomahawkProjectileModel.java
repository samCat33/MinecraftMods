...
public class TomahawkProjectileModel extends EntityModel<TomahawkProjectileEntity> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(SamMod.MOD_ID, "tomahawk"), "main");
    private final ModelPart tomahawk;


    //This constructor is used in the TomahawkProjectileRenderer class
