...
//Responsible for the pedestal interaction

//The slots defined here are not the slots the player sees
//because these are rendered in PedestalScreen, rather
//they are the places that items are logically
//held by the menu
public class PedestalMenu extends AbstractContainerMenu {

    //The block entity associated with the created menu
    ...
    public boolean stillValid(Player pPlayer) {
        ...
        //The Block that makes up the last argument must be the block corresponding
        //to the block entity, otherwise this method will not work
