...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(ModBlocks.RICE_CROP.get(), this.createCropDrops(ModBlocks.RICE_CROP.get(),
                ModItems.UNCOOKED_RICE_BAG.get(), ModItems.RICE_SEEDS.get(), lootItemConditionBuilder));


        //This applies to the blueberry bush, allowing the Fortune enchantment to be applied to them
        HolderLookup.RegistryLookup<Enchantment> registrylookup = this.registries.lookupOrThrow(Registries.ENCHANTMENT);

        //Defines how the Fortune enchantment applies to the blueberries
